                        ...
                        children: [
                          ...
                          Container(
                              ...
                              padding:
                                  const EdgeInsets.symmetric(horizontal: 10.0),
                              child: const CustomTextField(
                                hintText: "Selectionner le type de sang",
                              )),
                        ],
                      ),
                      Padding(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 10.0),
                                child: const CustomTextField(
                                  hintText: "Entrez le poids du patient",
                                )),
                          ],
                        ),
                      ),
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (context, int index) {
                                return GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      BloodInfo.groupeSanguin[index].active =
                                          !BloodInfo
                                              .groupeSanguin[index].active;
                                    });
                                  },
                                  child: SizedBox(
                                    height: 30,
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                        BloodInfo.groupeSanguin[index].groupe,
